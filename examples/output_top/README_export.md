...
## 如何返修
```bash
node scripts/apply_revision.js output_top 返修意见.md
# 或自然语言： node scripts/apply_revision.js output_top --text "第5页图片放大；所有加粗用北大红"
```
