...
| --- | --- |
| 模板 | `left-sidebar` |
| 标题 | 基于电子病历的中文医学文本结构化研究 |
| 副标题 | 面向临床决策支持的自然语言处理方法 |
| 答辩人 / 指导老师 | 张三 / 李四 教授 |
| 章节数 | 4 |
| 总页数 / 正文页 | 10 / 7 |
| 布局校验 | 通过（无高危问题） |
...
## 如何返修
```bash
node scripts/apply_revision.js output_left 返修意见.md
# 或自然语言： node scripts/apply_revision.js output_left --text "第5页图片放大；所有加粗用北大红"
```
